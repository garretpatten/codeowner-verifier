(() => {
  var __webpack_modules__ = {
    7351: function (e, p, a) {
      ...
      function issueCommand(e, p, a) {
        ...
        process.stdout.write(t.toString() + s.EOL);
      }
    ...
    5438: function (e, p, a) {
      ...
      function getOctokit(e, p, ...a) {
        const t = i.GitHub.plugin(...a);
        return new t(i.getOctokitOptions(e, p));
      }
    ...
    3030: function (e, p, a) {
      ...
      p.defaults = { baseUrl: u, request: { agent: i.getProxyAgent(u) } };
    ...
    6255: function (e, p, a) {
      ...
      const g = [u.BadGateway, u.ServiceUnavailable, u.GatewayTimeout];
      ...
      class HttpClient {
        ...
        postJson(e, p, a = {}) {
          return s(this, void 0, void 0, function* () {
            ...
            a[c.Accept] = this._getExistingOrDefaultHeader(
              a,
              c.Accept,
              h.ApplicationJson
            );
            a[c.ContentType] = this._getExistingOrDefaultHeader(
              a,
              c.ContentType,
              h.ApplicationJson
            );
        ...
        _getAgent(e) {
          ...
          if (a && a.hostname) {
            ...
            if (d) {
              t = s ? l.httpsOverHttps : l.httpsOverHttp;
            } else {
              t = s ? l.httpOverHttps : l.httpOverHttp;
            }
            p = t(e);
            this._proxyAgent = p;
          }
          if (this._keepAlive && !p) {
            ...
            p = d ? new o.Agent(e) : new i.Agent(e);
            this._agent = p;
          }
          if (!p) {
            p = d ? o.globalAgent : i.globalAgent;
          }
    ...
    9440: (e, p, a) => {
      ...
      const s = '6.0.12';
      const i = `octokit-endpoint.js/${s} ${d.getUserAgent()}`;
      const o = {
        method: 'GET',
    ...
    8467: (e, p, a) => {
      ...
      const n = withDefaults(t.request, {
        headers: {
          'user-agent': `octokit-graphql.js/${r} ${d.getUserAgent()}`,
        },
        method: 'POST',
        url: '/graphql',
      });
        ...
        return {
          [Symbol.asyncIterator]: () => ({
            async next() {
              ...
              try {
                const e = await d({ method: r, url: i, headers: s });
      ...
      function endpointsToMethods(e, p) {
        ...
        for (const [t, d] of Object.entries(p)) {
          for (const [p, r] of Object.entries(d)) {
            ...
            const u = a[t];
            if (i) {
              u[p] = decorate(e, t, p, l, i);
              continue;
            }
            u[p] = e.request.defaults(l);
          }
        }
        return a;
      }
    ...
    537: (e, p, a) => {
      ...
      var t = a(8932);
      var d = _interopDefault(a(1223));
      const r = d((e) => console.warn(e));
      const s = d((e) => console.warn(e));
    ...
    6234: (e, p, a) => {
        ...
        return o(
          ...
          .then(async (r) => {
            ...
            if (e.method === 'HEAD') {
              ...
              throw new i.RequestError(r.statusText, t, {
                response: { url: d, status: t, headers: a, data: undefined },
                request: e,
              });
            }
            if (t === 304) {
              throw new i.RequestError('Not modified', t, {
                response: {
                  url: d,
                  status: t,
                  headers: a,
            ...
            if (t >= 400) {
              ...
              const s = new i.RequestError(toErrorMessage(p), t, {
          ...
          .then((e) => ({ status: t, url: d, headers: a, data: e }))
          .catch((p) => {
      ...
      const n = withDefaults(t.endpoint, {
        headers: {
          'user-agent': `octokit-request.js/${o} ${d.getUserAgent()}`,
        },
      });
      p.request = n;
    },
    9417: (e) => {
      'use strict';
      e.exports = balanced;
      function balanced(e, p, a) {
        if (e instanceof RegExp) e = maybeMatch(e, a);
        if (p instanceof RegExp) p = maybeMatch(p, a);
        var t = range(e, p, a);
        return (
          t && {
            start: t[0],
            ...
            post: a.slice(t[1] + p.length),
          }
        );
      }
      function maybeMatch(e, p) {
        var a = p.match(e);
        return a ? a[0] : null;
      }
      balanced.range = range;
      function range(e, p, a) {
        var t, d, r, s, i;
        var o = a.indexOf(e);
        var n = a.indexOf(p, o + 1);
        var l = o;
        if (o >= 0 && n > 0) {
          if (e === p) {
            return [o, n];
    ...
    3682: (e, p, a) => {
      ...
      function bindApi(e, p, a) {
        var t = i(r, null).apply(null, a ? [p, a] : [p]);
        e.api = { remove: t };
        e.remove = t;
        ['before', 'error', 'after', 'wrap'].forEach(function (t) {
          var r = a ? [p, t, a] : [p, t];
          e[t] = e.api[t] = i(d, null).apply(null, r);
        });
      }
    ...
    3717: (e, p, a) => {
      var t = a(9417);
      e.exports = expandTop;
      var d = '\0SLASH' + Math.random() + '\0';
      var r = '\0OPEN' + Math.random() + '\0';
      var s = '\0CLOSE' + Math.random() + '\0';
      var i = '\0COMMA' + Math.random() + '\0';
      ...
      function expand(e, p) {
        ...
        if (!d) return [e];
        var r = d.pre;
        var i = d.post.length ? expand(d.post, false) : [''];
        if (/\$$/.test(d.pre)) {
          ...
          var l = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(d.body);
          var u = /^[a-zA-Z]\.\.[a-zA-Z](?:\.\.-?\d+)?$/.test(d.body);
          var c = l || u;
          var h = d.body.indexOf(',') >= 0;
          if (!c && !h) {
            if (d.post.match(/,.*\}/)) {
              e = d.pre + '{' + d.body + s + d.post;
              return expand(e);
            }
            return [e];
          }
          ...
          if (c) {
            var w = numeric(v[0]);
            var _ = numeric(v[1]);
            var T = Math.max(v[0].length, v[1].length);
            var b = v.length == 3 ? Math.abs(numeric(v[2])) : 1;
            var E = lte;
            var y = _ < w;
            if (y) {
              b *= -1;
            ...
            for (var D = w; E(D, _); D += b) {
              ...
              if (u) {
                ...
                if (S) {
                  var O = T - P.length;
                  if (O > 0) {
                    var A = new Array(O + 1).join('0');
                    if (D < 0) P = '-' + A + P.slice(1);
                    else P = A + P;
                  }
                }
              }
            ...
            for (var k = 0; k < v.length; k++) {
              g.push.apply(g, expand(v[k], false));
            }
          }
    ...
    3973: (e, p, a) => {
      const t = (e.exports = (e, p, a = {}) => {
        assertValidPattern(p);
        if (!a.nocomment && p.charAt(0) === '#') {
          return false;
        }
        return new Minimatch(p, a).match(e);
      });
      e.exports = t;
      const d = a(4917);
      t.sep = d.sep;
      ...
      const ext = (e, p = {}) => {
        const a = {};
        Object.keys(e).forEach((p) => (a[p] = e[p]));
        Object.keys(p).forEach((e) => (a[e] = p[e]));
        return a;
      };
      t.defaults = (e) => {
        ...
        const p = t;
        const m = (a, t, d) => p(a, t, ext(e, d));
        m.Minimatch = class Minimatch extends p.Minimatch {
          constructor(p, a) {
            super(p, ext(e, a));
          }
        };
        m.Minimatch.defaults = (a) => p.defaults(ext(e, a)).Minimatch;
        m.filter = (a, t) => p.filter(a, ext(e, t));
        m.defaults = (a) => p.defaults(ext(e, a));
        m.makeRe = (a, t) => p.makeRe(a, ext(e, t));
        m.braceExpand = (a, t) => p.braceExpand(a, ext(e, t));
        m.match = (a, t, d) => p.match(a, t, ext(e, d));
        return m;
      };
      t.braceExpand = (e, p) => braceExpand(e, p);
      const braceExpand = (e, p = {}) => {
      ...
      t.makeRe = (e, p) => new Minimatch(e, p || {}).makeRe();
      t.match = (e, p, a = {}) => {
        const t = new Minimatch(p, a);
      ...
      class Minimatch {
        constructor(e, p) {
          ...
          this.windowsPathsNoEscape =
            !!p.windowsPathsNoEscape || p.allowWindowsEscape === false;
        ...
        make() {
          ...
          if (p.debug) this.debug = (...e) => console.error(...e);
          this.debug(this.pattern, a);
          a = this.globParts = a.map((e) => e.split(v));
          this.debug(this.pattern, a);
          a = a.map((e, p, a) => e.map(this.parse, this));
          this.debug(this.pattern, a);
          a = a.filter((e) => e.indexOf(false) === -1);
          this.debug(this.pattern, a);
          this.set = a;
        }
        parseNegate() {
        ...
        matchOne(e, p, a) {
          var t = this.options;
          this.debug('matchOne', { this: this, file: e, pattern: p });
          this.debug('matchOne', e.length, p.length);
          for (
            var d = 0, s = 0, i = e.length, o = p.length;
            d < i && s < o;
            d++, s++
          ) {
            ...
            if (n === r) {
              ...
              while (u < i) {
                var h = e[u];
                this.debug('\nglobstar while', e, u, p, c, h);
                if (this.matchOne(e.slice(u), p.slice(c), a)) {
                  this.debug('globstar found match!', u, i, h);
                  return true;
                } else {
                  if (
                    h === '.' ||
                    ...
                    this.debug('dot detected!', e, u, p, c);
                    break;
                  }
            ...
            if (typeof n === 'string') {
              v = l === n;
              this.debug('string match', n, l, v);
            } else {
              v = l.match(n);
              this.debug('pattern match', n, l, v);
            }
            if (!v) return false;
          }
          if (d === i && s === o) {
        ...
        parse(e, p) {
          ...
          const clearStateChar = () => {
            if (v) {
              ...
              this.debug('clearStateChar %j %j', v, t);
              v = false;
            }
          };
          for (let p = 0, r; p < e.length && (r = e.charAt(p)); p++) {
            this.debug('%s\t%s %s %j', e, p, t, r);
            if (s) {
              if (r === '/') {
                return false;
              }
            ...
            switch (r) {
              ...
              case '@':
              case '!':
                this.debug('%s\t%s %s %j <-- stateChar', e, p, t, r);
                if (g) {
                  this.debug('  in class');
                  if (r === '!' && p === T + 1) r = '^';
                  t += r;
                ...
                this.debug('call clearStateChar %j', v);
                clearStateChar();
                v = r;
                if (a.noext) clearStateChar();
                continue;
              case '(': {
                if (g) {
                  t += '(';
                ...
                if (a.start === 0 && a.type !== '!') {
                  S = true;
                  t += subPatternStart(e.slice(p + 1));
                }
                this.debug('plType %j %j', v, t);
                v = false;
                continue;
              }
              case ')': {
                ...
                t += E.close;
                if (E.type === '!') {
                  u.push(Object.assign(E, { reEnd: t.length }));
                }
                continue;
              }
              case '|': {
              ...
              case ']':
                ...
                b = e.substring(T + 1, p);
                try {
                  RegExp('[' + braExpEscape(charUnescape(b)) + ']');
                  t += r;
                } catch (e) {
                  t = t.substring(0, _) + '(?:$.)';
                }
          ...
          for (E = l.pop(); E; E = l.pop()) {
            ...
            this.debug('tail=%j\n   %s', e, e, E, t);
            const p = E.type === '*' ? n : E.type === '?' ? o : '\\' + E.type;
            d = true;
            t = t.slice(0, E.reStart) + p + '\\(' + e;
          }
          clearStateChar();
          if (s) {
            t += '\\\\';
          }
          const P = h[t.charAt(0)];
          for (let e = u.length - 1; e > -1; e--) {
            const a = u[e];
            const d = t.slice(0, a.reStart);
            const r = t.slice(a.reStart, a.reEnd - 8);
            let s = t.slice(a.reEnd);
            const i = t.slice(a.reEnd - 8, a.reEnd) + s;
            const o = d.split(')').length;
            const n = d.split('(').length - o;
            let l = s;
            for (let e = 0; e < n; e++) {
              l = l.replace(/\)[+*?]?/, '');
            }
        ...
        makeRe() {
          ...
          const p = this.options;
          const a = p.noglobstar ? n : p.dot ? l : u;
          const t = p.nocase ? 'i' : '';
          let d = e
            .map((e) => {
              e = e
                .map((e) =>
                  typeof e === 'string' ? regExpEscape(e) : e === r ? r : e._src
                )
                .reduce((e, p) => {
                  if (!(e[e.length - 1] === r && p === r)) {
                    e.push(p);
                  }
                  return e;
                }, []);
              ...
              return e.filter((e) => e !== r).join('/');
            })
            .join('|');
          d = '^(?:' + d + ')$';
          if (this.negate) d = '^(?!' + d + ').*$';
          try {
            this.regexp = new RegExp(d, t);
          } catch (e) {
            this.regexp = false;
          }
          return this.regexp;
        }
        match(e, p = this.partial) {
          ...
          for (let d = 0; d < t.length; d++) {
            const s = t[d];
            let i = e;
            if (a.matchBase && s.length === 1) {
              i = [r];
            }
            const o = this.matchOne(i, s, p);
            if (o) {
              if (a.flipNegate) return true;
              return !this.negate;
            }
          }
          if (a.flipNegate) return false;
          return this.negate;
        }
        static defaults(e) {
    ...
    467: (e, p, a) => {
      ...
      function consumeBody() {
        ...
        let d = 0;
        let r = false;
        return new Body.Promise(function (t, s) {
          let i;
          if (e.timeout) {
      ...
      class Headers {
        ...
        get(e) {
          e = `${e}`;
          validateName(e);
          const p = find(this[_], e);
          if (p === undefined) {
            return null;
          }
          return this[_][p].join(', ');
        }
        forEach(e) {
          let p =
            arguments.length > 1 && arguments[1] !== undefined
        ...
        set(e, p) {
          ...
          validateName(e);
          validateValue(p);
          const a = find(this[_], e);
          this[_][a !== undefined ? a : e] = [p];
        }
        append(e, p) {
          e = `${e}`;
          p = `${p}`;
      ...
      function getHeaders(e) {
        ...
        return a.map(
          p === 'key'
            ...
            : function (p) {
                return [p.toLowerCase(), e[_][p].join(', ')];
              }
        );
      }
      ...
      function exportNodeCompatibleHeaders(e) {
        const p = Object.assign({ __proto__: null }, e[_]);
        const a = find(e[_], 'Host');
        if (a !== undefined) {
          p[a] = p[a][0];
        }
        return p;
      ...
      const A = 'destroy' in t.Readable.prototype;
      ...
      function getNodeRequestOptions(e) {
        ...
        if (e.signal && e.body instanceof t.Readable && !A) {
          throw new Error(
      ...
      const k = r.URL || s.URL;
      const N = t.PassThrough;
      const G = function isDomainOrSubdomain(e, p) {
      ...
      function fetch(e, p) {
        ...
        return new fetch.Promise(function (a, r) {
          ...
          const l = (n.protocol === 'https:' ? i : d).request;
          const u = s.signal;
          let c = null;
          const h = function abort() {
            let e = new AbortError('The user aborted a request.');
            r(e);
            if (s.body && s.body instanceof t.Readable) {
          ...
          function finalize() {
            g.abort();
            if (u) u.removeEventListener('abort', v);
            clearTimeout(w);
          }
          if (s.timeout) {
          ...
          fixResponseChunkedTransferBadEnding(g, function (e) {
            if (u && u.aborted) {
              return;
            }
            destroyStream(c.body, e);
          ...
          g.on('response', function (e) {
            ...
            if (fetch.isRedirect(e.statusCode)) {
              ...
              let d = null;
              try {
                d = t === null ? null : new k(t, s.url).toString();
              } catch (e) {
    ...
    5840: (e, p, a) => {
      ...
      var d = _interopRequireDefault(a(6409));
      ...
      var u = _interopRequireDefault(a(2746));
    ...
    8628: (e, p, a) => {
      ...
      function v1(e, p, a) {
        ...
        e = e || {};
        let u = e.node || r;
        let c = e.clockseq !== undefined ? e.clockseq : s;
        if (u == null || c == null) {
          const p = e.random || (e.rng || t.default)();
          if (u == null) {
            u = r = [p[0] | 1, p[1], p[2], p[3], p[4], p[5]];
          }
          if (c == null) {
            c = s = ((p[6] << 8) | p[7]) & 16383;
          }
    ...
    6409: (e, p, a) => {
      ...
      var d = _interopRequireDefault(a(4569));
      function _interopRequireDefault(e) {
        return e && e.__esModule ? e : { default: e };
      }
    ...
    5998: (e, p, a) => {
      ...
      var d = _interopRequireDefault(a(2746));
      function _interopRequireDefault(e) {
        return e && e.__esModule ? e : { default: e };
      }
    ...
    9120: (e, p, a) => {
      ...
      p['default'] = void 0;
      var t = _interopRequireDefault(a(5998));
      var d = _interopRequireDefault(a(5274));
      function _interopRequireDefault(e) {
        return e && e.__esModule ? e : { default: e };
      }
  ...
  (() => {
    const e = __nccwpck_require__(2186);
    const p = __nccwpck_require__(5438);
    const { Octokit: a } = __nccwpck_require__(6762);
    const t = __nccwpck_require__(7147);
    const d = __nccwpck_require__(3973);
    const r = 'apiToken';
    const s = 'changedFiles';
    const i = 'deletedFiles';
    const o = 'ignoreList';
    const n = 'timestamp';
    function buildCodeownersMap() {
      ...
      for (let e of p) {
        if (e.substring(0, 1) != '#' && e.length > 1) {
          if (e.indexOf('\\ ') !== -1) {
            a = handleFilepathWithSpace(e);
          } else {
            a = e.split(' ');
          }
          if (a.length > 1) {
            a[0] = cleanPath(a[0]);
            d.set(a[0], getCodeowners(a));
          }
        }
      }
      return d;
    ...
    function getChangedFilesWithoutOwnership(e, p, a, t) {
      const d = [...p.keys()];
      let r = [...e];
      let s = [];
      s = t != '' ? s.concat(t) : s;
    ...
    function getTeams(e) {
      let p = new Promise((p, t) => {
        (async () => {
          let d;
          try {
            d = await new a({ auth: e }).request('GET /orgs/ncino/teams');
          } catch (e) {
            t(e);
          }
          if (d && d.data) {
    ...
    function isFileExtensionMatch(e, p) {
      if (p.substring(0, 2) == '*.') {
        return e.includes(p.substring(1));
      }
      return false;
    }
    function isFirstLevelDirectoryMatch(e, p) {
      if (p.indexOf('/*') !== -1) {
        if (p == '/*') {
          return !e.includes('/');
        } else {
    ...
    function isFullDirectoryMatch(e, p) {
      if (p.substring(p.length - 1) == '/') {
        return e.includes(p.substring(1));
      }
      return false;
    }
    function isMatch(e, p) {
      const a = [
        d,
    ...
    function verifyCodeowners() {
      const a = null;
      const t = p.context.payload.repository.full_name.split('/')[1];
      console.log(
        'Running codeowners-validator action for the ' + t + ' repository...'
      );
      const d = e.getInput(r);
      const l = e.getInput(s);
      const u = handleWhiteSpaceForChangedFiles(l);
      const c = e.getInput(i);
      const h = handleWhiteSpaceInFilepaths(c);
      const v = e.getInput(o);
      const g = v.split(' ');
      let w = null;
      if (d != null) {
        w = new Promise((e, p) => {
      ...
      const _ = buildCodeownersMap();
      const T = getChangedFilesWithoutOwnership(u, _, h, g);
      let b = [];
      if (w != null) {
        w.then((e) => {
          let p;
      ...
      e.setOutput(n, new Date().toTimeString());
    }
    verifyCodeowners();
  })();
